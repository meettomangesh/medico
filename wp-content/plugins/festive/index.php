...
get_header(); ?>
	...
	<?php if ( is_home() ) : ?>
	<div id="primary" class="content-area <?php echo ( get_theme_mod( 'festive-blog-full-width' ) ) ? sanitize_html_class( ' content-area-full' ) : ''; ?>">
    <?php else : ?>
	...
	<?php if ( is_home() ) : ?>
        ...
        <?php if ( get_theme_mod( 'festive-blog-full-width' ) ) : ?>
            <!-- No Sidebar -->
        <?php else : ?>
            <?php get_sidebar(); ?>
        <?php endif; ?>
