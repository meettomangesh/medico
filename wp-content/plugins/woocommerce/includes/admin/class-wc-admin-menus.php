...
function register_my_custom_menu_page(){
    ...
    // creating admin menu 
    add_menu_page('Enquiry report', 'Enquiry report', 'edit_posts','enquiry',array( $this, 'custom_list_page' ), '', 8 );
	//add_menu_page( __( 'Enquiry reports', 'woocommerce' ),  __( 'Enquiry reports', 'woocommerce' ) , 'view_enquiry_reports', 'wc-reports', array( $this, 'custom_list_page' ), null, '55.6' );
}
function custom_list_page(){
    // include your custom 
    require_once get_template_directory().'/mycustomtabel.php';
