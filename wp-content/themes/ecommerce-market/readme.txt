...
eCommerce Market WordPress Theme, Copyright (C) 2017, Rigorous Themes
eCommerce Market is distributed under the terms of the GNU GPL
...
JS Files    
    ...
    Portfolio JS : MIT license
    http://portfoliojs.com/

    Waypoints Js : MIT license
...
Images
    Image used in screenshot
        https://pixabay.com/en/blur-close-up-focus-hanger-jacket-1850082/

    popup.png
        https://pixabay.com/en/people-girl-standing-talking-phone-2581913/    
    ...
    Other Images:      
        ...
        down-arrow.png self created GPLv2  
        top-seller-deco.png self created GPLv2  
...
= 1.0.5 - Nov 30 2017 =
* Fix License issue.
* Added License of breadcrumb and TGM plugin activation

= 1.0.4 - Nov 22 2017 =
* Create pot file file
* Remove unused file
...
= 1.0.1 - Nov 3 2017 =
* Fixing escapaing and translation.
* Fix design issue.
